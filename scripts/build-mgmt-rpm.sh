...
echo ""
echo "Deploy (RHEL/Rocky/Alma amd64):"
echo "  sudo rpm -Uvh ${OUT_DIR}/pertisk-mgmt-*.rpm"
echo "  sudo systemctl enable --now pertisk-mgmt"
echo "  # edit /etc/pertisk-mgmt/pertisk-mgmt.env then: sudo systemctl restart pertisk-mgmt"
