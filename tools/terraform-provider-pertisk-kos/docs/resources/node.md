---
page_title: "pertisk-kos_node Resource - pertisk-kos"
subcategory: ""
description: |-
  Add a VM node or adopt an existing host into a Pertisk cluster.
---

# pertisk-kos_node (Resource)

Add a worker or control-plane after cluster create. Prefer this over changing `pertisk-kos_cluster.workers` / `controlplanes` (those are create-time only).
...
# resource "pertisk-kos_node" "bare" {
#   cluster_id = pertisk-kos_cluster.lab.id
#   role       = "worker"
#   mode       = "adopt"
#   ip         = "10.1.1.50"
...
```shell
terraform import pertisk-kos_node.extra_worker <cluster_id>/<node_id>
```
