...
func TestProviderMetadata(t *testing.T) {
	...
	if resp.TypeName != "pertisk-kos" {
		t.Fatalf("TypeName = %q, want pertisk-kos", resp.TypeName)
	}
...
func TestAddonResourceTypeName(t *testing.T) {
	...
	r.Metadata(context.Background(), resource.MetadataRequest{ProviderTypeName: "pertisk-kos"}, &resp)
	if resp.TypeName != "pertisk-kos_addon" {
		t.Fatalf("TypeName = %q, want pertisk-kos_addon", resp.TypeName)
	}
}
